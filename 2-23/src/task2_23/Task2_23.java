...
public class Task2_23 {
    public static void main(String[] args) {
        ...
        //ここに解答
        Student yamadaStudent = new Student("山田太郎", Constants.LANGUAGE_JAVA);
        Student ishitaniStudent = new Student("石谷花子", Constants.LANGUAGE_HTML);
        
        yamadaStudent.studyLanguage(); 
        ishitaniStudent.studyLanguage();
